...
import irelandFlag from '../../Images/ireflag.png';
    ...
    <div className='footer-sub'>
      <ul className='footer-list footer-list-left'>
        ...
        <li>
          <a
            className='social-icon'
            href='https://instagram.com/madebygoogle'
            target='_blank'
          >
            <svg viewBox='0 0 48 48'>
              <g className='gray-fill'>
        ...
        <li>
          <a
            className='social-icon'
            href='https://facebook.com/madebygoogle'
            target='_blank'
          >
        ...
        <li>
          <a
            className='social-icon'
            href='https://youtube.com/madebygoogle'
            target='_blank'
          >
            <svg viewBox='0 0 48 48'>
              <g className='gray-fill'>
      ...
      <ul className='footer-list footer-list-right'>
        <li className='localization-link'>
          <a href='/' className='footer-link'>
            <img className='footer-flag' src={irelandFlag} alt='Ireland Flag' />
            <div className='localization-link-text'>Ireland</div>
          </a>
        </li>
        <li>
          <a href='/' className='footer-link'>
